...
function StudentsSectionFilters() {
...
<div className="w-[900px] h-[110px] mt-[90px]">
        <form action="" className="flex items-center justify-between">
          ...
          <div>
            <button type="submit" className="w-[92px] h-[32px] bg-[#3482F7] text-white rounded-[6px] text-[16px] font-[700]">Show</button>
          </div>
        </form>
      </div>
...
export default StudentsSectionFilters
